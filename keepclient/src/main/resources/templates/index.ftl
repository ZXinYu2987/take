                ...
                <div class="shoptext">
                    <form id="ff" method="post">
                        ...
                        <div style="height: 30px">
                            <label for="saddress"><b>地址:</b></label>
                            <input class="easyui-validatebox" type="text" name="saddress" readonly="readonly"/>
                        </div>
                        <div style="height: 30px">
                            <label for="sphone"><b>电话:</b></label>
                            <input class="easyui-validatebox" type="text" name="sphone"  readonly="readonly"/>
                        </div>
                        <div style="height: 30px">
                            <label for="sdishes"><b>特色菜品:</b></label>
                            <input class="easyui-validatebox" type="text" name="sdishes"  readonly="readonly"/>
                        </div>
                        <div style="height: 30px">
                            <label for="sdishes"><b>营业时间:</b></label>
                            <input class="easyui-validatebox" type="text" name="sdateB"  readonly="readonly"/>- <input class="easyui-validatebox" type="text" name="sdateE"  readonly="readonly"/>
                        </div>
                    ...
                    <div class="Button" style="margin-top: 200px">
                        <a href="#ydwm"><span class="DCbutton">查看菜谱点菜</span></a>
                    </div>
                    <div class="otherinfor">
                        <a href="javascript:;" onclick="keep()" class="icoa"><img src="images/collect.png">收藏店铺 <span>
                                <input  type="text" width="5px" value="0" id="total">
                            </span></a>
